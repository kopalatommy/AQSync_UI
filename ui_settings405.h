...
public:
    ...
    void setupUi(QDialog *settings405)
    {
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8("../../Buttons/Adaptive_Filter_Setting.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        AdaptiveFilter->setIcon(icon6);
        AdaptiveFilter->setIconSize(QSize(150, 90));
        dataFileMenu = new QPushButton(settings405);
        dataFileMenu->setObjectName(QString::fromUtf8("dataFileMenu"));
        dataFileMenu->setGeometry(QRect(460, 330, 150, 90));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8("../../Buttons/button_data-file-menu.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8("../../Buttons/button_no-calibration.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        NOCalibration->setIcon(icon8);
