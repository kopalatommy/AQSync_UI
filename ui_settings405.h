...
public:
    ...
    void setupUi(QDialog *settings405)
    {
        ...
        Mode_2->setGeometry(QRect(460, 140, 150, 90));
        QIcon icon2;
        ...
        Main_Settings->setGeometry(QRect(0, 0, 801, 111));
        QFont font;
        ...
        FlowCalibration->setGeometry(QRect(180, 360, 150, 90));
        QIcon icon4;
        ...
        NO2Calibration->setGeometry(QRect(460, 250, 150, 90));
        QIcon icon5;
        ...
        Parameters->setGeometry(QRect(460, 360, 150, 90));
        QIcon icon6;
        ...
        NOCalibration->setGeometry(QRect(180, 250, 150, 90));
        QIcon icon7;
        ...
        AdaptiveFilter->setGeometry(QRect(180, 140, 150, 90));
        QIcon icon8;
