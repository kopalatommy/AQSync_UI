...
void ModbusSlave::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ModbusSlave::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ModbusSlave::ReceivedNewSettings)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ModbusSlave::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ModbusSlave::TriggerOutputFunction)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ModbusSlave::*)(QByteArray , QTcpSocket * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ModbusSlave::WriteData)) {
                *result = 2;
                return;
            }
        }
