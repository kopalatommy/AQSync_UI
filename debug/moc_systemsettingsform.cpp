...
void SystemSettingsForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SystemSettingsForm *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SystemSettingsForm::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SystemSettingsForm::CloseForms)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SystemSettingsForm::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SystemSettingsForm::MoveLeft)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SystemSettingsForm::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SystemSettingsForm::MoveRight)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SystemSettingsForm::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_SystemSettingsForm.data,
    qt_meta_data_SystemSettingsForm,
    qt_static_metacall,
    nullptr,
    nullptr
} };
