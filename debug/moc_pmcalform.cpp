...
void PMCalForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PMCalForm *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (PMCalForm::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PMCalForm::CloseForms)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (PMCalForm::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PMCalForm::MoveLeft)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (PMCalForm::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PMCalForm::MoveRight)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject PMCalForm::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_PMCalForm.data,
    qt_meta_data_PMCalForm,
    qt_static_metacall,
    nullptr,
    nullptr
} };
