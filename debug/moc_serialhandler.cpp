...
QT_MOC_LITERAL(1, 14, 6), // "ParseA"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 20), // "QList<unsigned char>"
QT_MOC_LITERAL(4, 43, 3), // "lst"
QT_MOC_LITERAL(5, 47, 6), // "ParseB"
QT_MOC_LITERAL(6, 54, 11), // "ReadSerialA"
QT_MOC_LITERAL(7, 66, 11) // "ReadSerialB"

    },
    "SerialHandler\0ParseA\0\0QList<unsigned char>\0"
    "lst\0ParseB\0ReadSerialA\0ReadSerialB"
};
...
void SerialHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ParseA((*reinterpret_cast< QList<unsigned char>(*)>(_a[1]))); break;
        case 1: _t->ParseB((*reinterpret_cast< QList<unsigned char>(*)>(_a[1]))); break;
        case 2: _t->ReadSerialA(); break;
        case 3: _t->ReadSerialB(); break;
        default: ;
        }
        ...
        {
            typedef void (SerialHandler::*_t)(QList<unsigned char> );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialHandler::ParseA)) {
                *result = 0;
            }
        }
        {
            typedef void (SerialHandler::*_t)(QList<unsigned char> );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialHandler::ParseB)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void SerialHandler::ParseA(QList<unsigned char> _t1)
{
...
// SIGNAL 1
void SerialHandler::ParseB(QList<unsigned char> _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
