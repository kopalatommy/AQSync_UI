...
void ModeForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ModeForm::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ModeForm::CloseForms)) {
                *result = 0;
            }
        }
        {
            typedef void (ModeForm::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ModeForm::MoveLeft)) {
                *result = 1;
            }
        }
        {
            typedef void (ModeForm::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ModeForm::MoveRight)) {
                *result = 2;
            }
        }
    }
