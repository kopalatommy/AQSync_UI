...
const QMetaObject dataselection405form::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_dataselection405form.data,
      qt_meta_data_dataselection405form,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *dataselection405form::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_dataselection405form.stringdata0))
        return static_cast<void*>(const_cast< dataselection405form*>(this));
