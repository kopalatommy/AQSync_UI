...
void Calibration880nm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Calibration880nm *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Calibration880nm::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_Calibration880nm.data,
    qt_meta_data_Calibration880nm,
    qt_static_metacall,
    nullptr,
    nullptr
} };
