...
void BCPSerialHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (BCPSerialHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BCPSerialHandler::NewAvgTime)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (BCPSerialHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BCPSerialHandler::NewDateSetting)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (BCPSerialHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BCPSerialHandler::NewTimeStting)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (BCPSerialHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BCPSerialHandler::NewAdFilterSettingsBCP)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (BCPSerialHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BCPSerialHandler::NewAutoZeroSettingBCP)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (BCPSerialHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BCPSerialHandler::New880CalSettingsBCP)) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (BCPSerialHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BCPSerialHandler::New405CalSettingsBCP)) {
                *result = 7;
                return;
            }
        }
        {
            using _t = void (BCPSerialHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BCPSerialHandler::NewFlowCalSettingsBCP)) {
                *result = 8;
                return;
            }
        }
        {
            using _t = void (BCPSerialHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BCPSerialHandler::NewTPCorrSettingsBCP)) {
                *result = 9;
                return;
            }
        }
