...
#include "../Modbus/modbusdatatable.h"
...
const QMetaObject ModbusDataTable::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ModbusDataTable.data,
      qt_meta_data_ModbusDataTable,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ModbusDataTable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ModbusDataTable.stringdata0))
        return static_cast<void*>(const_cast< ModbusDataTable*>(this));
