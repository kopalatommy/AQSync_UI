...
void AutoZeroBCP::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AutoZeroBCP *_t = static_cast<AutoZeroBCP *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject AutoZeroBCP::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AutoZeroBCP.data,
      qt_meta_data_AutoZeroBCP,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AutoZeroBCP::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AutoZeroBCP.stringdata0))
        return static_cast<void*>(const_cast< AutoZeroBCP*>(this));
