...
QT_MOC_LITERAL(4, 57, 15) // "on_Home_clicked"
    ...
    "flowcalibration405form\0on_Left_clicked\0"
...
void flowcalibration405form::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<flowcalibration405form *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject flowcalibration405form::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_flowcalibration405form.data,
    qt_meta_data_flowcalibration405form,
    qt_static_metacall,
    nullptr,
    nullptr
} };
