...
public:
    ...
    void setupUi(QWidget *FlowCalibration405Form)
    {
        ...
        cellFlowLabel->setGeometry(QRect(280, 120, 331, 121));
        QFont font;
        ...
        ozoneFlowLabel->setGeometry(QRect(270, 260, 511, 121));
    ...
    void retranslateUi(QWidget *FlowCalibration405Form)
    {
        ...
        cellFlowLabel->setText(QApplication::translate("FlowCalibration405Form", "Slope: ", 0));
        Next->setText(QString());
        Previous->setText(QString());
        ozoneFlowLabel->setText(QApplication::translate("FlowCalibration405Form", "Ozone:", 0));
