...
public:
    ...
    void setupUi(QWidget *SystemSettingsForm)
    {
        if (SystemSettingsForm->objectName().isEmpty())
            SystemSettingsForm->setObjectName(QString::fromUtf8("SystemSettingsForm"));
        ...
        createEveryDay->setObjectName(QString::fromUtf8("createEveryDay"));
        ...
        dataSpaceLabel->setObjectName(QString::fromUtf8("dataSpaceLabel"));
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8("../Buttons/button_check-for-update.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8("../Buttons/CleanLogsButton.jpg"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    {
        SystemSettingsForm->setWindowTitle(QApplication::translate("SystemSettingsForm", "Form", nullptr));
        closeButton->setText(QString());
        moveRightButton->setText(QString());
        moveLeftButton->setText(QString());
        Title->setText(QApplication::translate("SystemSettingsForm", "System Settings Form", nullptr));
        createEveryDay->setText(QApplication::translate("SystemSettingsForm", "Create new data file every day", nullptr));
        applyButton->setText(QApplication::translate("SystemSettingsForm", "Apply", nullptr));
        dataSpaceLabel->setText(QApplication::translate("SystemSettingsForm", "Space used: 100mb / 400 mb : 25 %", nullptr));
        updateLabel->setText(QApplication::translate("SystemSettingsForm", "Current Version: Build 1", nullptr));
