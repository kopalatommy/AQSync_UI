...
#define ADAPTIVEFILTER_BCP_INDEX 7
#define AUTOZERO_BCP_INDEX 8
#define CALIBRATION_405NM_INDEX 9
#define CALIBRATION_880NM_INDEX 10
#define FLOWCALIBRATION_BCP_INDEX 11
#define TPCORRECTION_BCP_INDEX 12
